...
/* ── AnimatedNumber ──
   ...
   Why round-before-format: most KPI numbers are integers (project
   counts, follow-ups, MXN amounts), so rendering "$1499.34"
   ...
   values can opt out by passing their own format.
