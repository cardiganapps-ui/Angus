...
describe("groupNotesByRecency", () => {
  ...
  it("pinned notes float to the top regardless of date", () => {
    const notes = [
      { id: "a", pinned: false, updatedAt: hoursAgo(1) },
      { id: "b", pinned: true, updatedAt: daysAgo(40) },
      { id: "c", pinned: false, updatedAt: daysAgo(2) },
    ];
  ...
  it("orders buckets: today, yesterday, thisWeek, thisMonth", () => {
    const notes = [
      { id: "1", pinned: false, updatedAt: hoursAgo(1) },        // today
      { id: "2", pinned: false, updatedAt: daysAgo(1) },         // yesterday
      { id: "3", pinned: false, updatedAt: daysAgo(3) },         // thisWeek
      { id: "4", pinned: false, updatedAt: "2026-04-01T12:00:00" }, // thisMonth
    ];
    const out = groupNotesByRecency(notes, t, NOW);
  ...
  it("sorts month-year buckets newest first after standard buckets", () => {
    const notes = [
      { id: "a", pinned: false, updatedAt: "2025-12-10T12:00:00" }, // 2025-12
      { id: "b", pinned: false, updatedAt: "2025-06-10T12:00:00" }, // 2025-06
      { id: "c", pinned: false, updatedAt: hoursAgo(1) },           // today
    ];
    const out = groupNotesByRecency(notes, t, NOW);
  ...
  it("preserves within-bucket input order", () => {
    const notes = [
      { id: "first", pinned: false, updatedAt: hoursAgo(0.5) },
      { id: "second", pinned: false, updatedAt: hoursAgo(1) },
      { id: "third", pinned: false, updatedAt: hoursAgo(2) },
    ];
    const out = groupNotesByRecency(notes, t, NOW);
